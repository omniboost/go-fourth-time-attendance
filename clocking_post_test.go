...
func TestPostClockRequest(t *testing.T) {
	...
	req.RequestBody().Root.Record = []fourth_time_attendance.Record{
		{EmpNo: "255", Location: "SCDEMO1", ClockStatus: fourth_time_attendance.ClockStatusCheckIn, CheckIn: fourth_time_attendance.DateTime{time.Date(2025, 03, 25, 8, 30, 0, 0, time.UTC)}, CheckOut: fourth_time_attendance.DateTime{}, ActualMinutes: "0", Notes: ""},
